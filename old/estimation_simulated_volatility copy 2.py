...
real_covariances = [Phi_Hl(0, 0.1) + 2 * Phi_Hl(1, 0.1)] + [Phi_Hl(i, 0.1) for i in range(2,max_lag+1)]
fit_covariances = [Phi_Hl(0, H_total) + 2 * Phi_Hl(1, H_total)] + [Phi_Hl(i, H_total) for i in range(2,max_lag+1)]
